...
volatile float angle; // The angle calculated by the Kalman filter - part of the 2x1 state vector
volatile float bias; // The gyro bias calculated by the Kalman filter - part of the 2x1 state vector
volatile float rate; // Unbiased rate calculated from the rate and the calculated bias - you have to call getAngle to update the rate

volatile float P_[2][2]; // Error covariance matrix - This is a 2x2 matrix
float K[2];
